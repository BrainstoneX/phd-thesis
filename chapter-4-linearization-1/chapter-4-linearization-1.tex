...
\foreach \x in {0,...,5}{\fill (p\x) circle (0.06);}
...
\foreach \x in {1,...,6}{\fill (p\x) circle (0.06);}
...
\draw[decoration={markings,mark=at position 0.66 with {\arrow[scale=1.5,>=stealth]{>}}},
   postaction={decorate},line width=1.0pt]  (p1)--(p2);
\draw[decoration={markings,mark=at position 0.66 with {\arrow[scale=1.5,>=stealth]{>}}},
   postaction={decorate},line width=1.0pt]  (p3)--(p4);
\draw[decoration={markings,mark=at position 0.66 with {\arrow[scale=1.5,>=stealth]{>}}},
   postaction={decorate},line width=1.0pt]  (p5)--(p6);

\draw[decoration={markings,mark=at position 0.54 with {\arrow[scale=1.5,>=stealth]{>}}},
   postaction={decorate},line width=1.0pt]  (p2) to[out=76,in=111] (p3);
\draw[decoration={markings,mark=at position 0.54 with {\arrow[scale=1.5,>=stealth]{>}}},
   postaction={decorate},line width=1.0pt]  (p2) to[out=-71,in=-104] (p3);

\draw[decoration={markings,mark=at position 0.54 with {\arrow[scale=1.5,>=stealth]{>}}},
   postaction={decorate},line width=1.0pt]  (p4) to[out=69,in=116] (p5);
\draw[decoration={markings,mark=at position 0.54 with {\arrow[scale=1.5,>=stealth]{>}}},
   postaction={decorate},line width=1.0pt]  (p4) to[out=-72,in=-109] (p5);
...
\foreach \x in {0,...,3}{\fill (p\x) circle (0.06);}
...
\foreach \x in {1,2}
  {\draw[decoration={markings,mark=at position 0.62 with {\arrow[scale=1.5,>=stealth]{>}}},
      postaction={decorate},line width=1.0pt] (p0)--(p\x);
   \draw[decoration={markings,mark=at position 0.64 with {\arrow[scale=1.5,>=stealth]{>}}},
      postaction={decorate},line width=1.0pt] (p\x)--(p3);}

\draw[decoration={markings,mark=at position 0.58 with {\arrow[scale=1.5,>=stealth]{>}}},
   postaction={decorate},line width=1.0pt]  (p1) to[out=-120,in=120] (p2);
\draw[decoration={markings,mark=at position 0.58 with {\arrow[scale=1.5,>=stealth]{>}}},
   postaction={decorate},line width=1.0pt]  (p2) to[out=60,in=-60] (p1);
...
In this section we will show that the problems VALID-LINEARIZATION and LIN-QSPP
...
We consider an instance of TWO-VERTEX-DISJOINT-PATHS with the properties as in Proposition~\ref{pr:FHW},
