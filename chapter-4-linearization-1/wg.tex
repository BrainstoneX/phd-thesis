...
\titlerunning{Linearizable special cases of the QSPP}

\author{Eranda \c{C}ela\inst{1}\and
~Bettina Klinz\inst{1}\and
~Stefan Lendl\inst{1}\\
James B. Orlin\inst{2}\and
~Gerhard J. Woeginger\inst{3}\and
Lasse Wulf\inst{1}}

\authorrunning{E. \c{C}ela et al.}
\institute{Institute of Discrete Mathematics, TU Graz, Austria\and
Sloan School of Management,  M.I.T., Cambridge, USA\and
...
\node at ( 0.60, 0.00) {\large$s$};
\node at ( 8.40, 1.00) {\large$t$};

\foreach \x in {1,...,8}
{\draw[decoration={markings,mark=at position 0.66 with {\arrow[scale=1.5,>=stealth]{>}}},
    postaction={decorate},line width=1.00pt] (\x,0)--(\x,1);}

\foreach \x in {1,...,7}
{\draw[decoration={markings,mark=at position 0.66 with {\arrow[scale=1.5,>=stealth]{>}}},
    postaction={decorate},line width=1.00pt] (\x,0)--(\x+1,0);
 \draw[decoration={markings,mark=at position 0.66 with {\arrow[scale=1.5,>=stealth]{>}}},
    postaction={decorate},line width=1.00pt] (\x,1)--(\x+1,1);}
...
\foreach \x in {0,...,4}
  {\pgfmathsetmacro{\y}{\x+1};
   \draw[decoration={markings,mark=at position 0.66 with {\arrow[scale=1.5,>=stealth]{>}}},
      postaction={decorate},line width=1.20pt] (p\x)--(p\y);}

\draw[decoration={markings,mark=at position 0.55 with {\arrow[scale=1.5,>=stealth]{>}}},
   postaction={decorate},line width=1.20pt]  (p2) to[out=45,in=135] (p5);
\draw[decoration={markings,mark=at position 0.52 with {\arrow[scale=1.5,>=stealth]{>}}},
   postaction={decorate},line width=1.20pt]  (p0) to[out=-45,in=-135] (p3);
\draw[decoration={markings,mark=at position 0.56 with {\arrow[scale=1.5,>=stealth]{>}}},
   postaction={decorate},line width=1.20pt]  (p1) to[out=-45,in=-135] (p4);
...
\draw[decoration={markings,mark=at position 0.66 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (p1)--(p2);
\draw[decoration={markings,mark=at position 0.66 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (p3)--(p4);
\draw[decoration={markings,mark=at position 0.66 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (p5)--(p6);

\draw[decoration={markings,mark=at position 0.54 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (p2) to[out=76,in=111] (p3);
\draw[decoration={markings,mark=at position 0.54 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (p2) to[out=-71,in=-104] (p3);

\draw[decoration={markings,mark=at position 0.54 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (p4) to[out=69,in=116] (p5);
\draw[decoration={markings,mark=at position 0.54 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (p4) to[out=-72,in=-109] (p5);
...
\foreach \x in {1,2}
  {\draw[decoration={markings,mark=at position 0.62 with {\arrow[scale=1.0,>=stealth]{>}}},
      postaction={decorate},line width=1.00pt] (p0)--(p\x);
   \draw[decoration={markings,mark=at position 0.64 with {\arrow[scale=1.0,>=stealth]{>}}},
      postaction={decorate},line width=1.00pt] (p\x)--(p3);}

\draw[decoration={markings,mark=at position 0.58 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (p1) to[out=-120,in=120] (p2);
\draw[decoration={markings,mark=at position 0.58 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (p2) to[out=60,in=-60] (p1);
...
\foreach \x in {1,...,3}
  {\draw[decoration={markings,mark=at position 0.33 with {\arrow[scale=1.0,>=stealth]{>}}},
      postaction={decorate},line width=1.00pt] (p1)--(q\x);
   \draw[decoration={markings,mark=at position 0.75 with {\arrow[scale=1.0,>=stealth]{>}}},
      postaction={decorate},line width=1.00pt] (q\x)--(p2);}

\draw[decoration={markings,mark=at position 0.57 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (p3) to[out=160,in=-70] (q1);
\draw[decoration={markings,mark=at position 0.51 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (q1) to[out=-30,in=120] (p3);

\draw[decoration={markings,mark=at position 0.57 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (p3) to[out=120,in=-120] (q2);
\draw[decoration={markings,mark=at position 0.52 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (q2) to[out=-60,in=60] (p3);

\draw[decoration={markings,mark=at position 0.57 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (p3) to[out=60,in=-150] (q3);
\draw[decoration={markings,mark=at position 0.51 with {\arrow[scale=1.0,>=stealth]{>}}},
   postaction={decorate},line width=1.00pt]  (q3) to[out=-110,in=20] (p3);
