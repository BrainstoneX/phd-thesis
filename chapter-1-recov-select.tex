...
We present computational experiments in Section~\ref{sec:experiments}, comparing different exact solution approaches developed in this chapter. Finally, Section~\ref{sec:conclusions} concludes the chapter, and further research questions are pointed out.
